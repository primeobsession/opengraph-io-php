...
3. Now just autoload your composer dependencies again using
    ...
    ```
4. Now yu should be able to access `OpenGraphClient` using proper namespace
    ```php
...
* After releasing this package to Packagist you will be able to require it via Composer as following
    ```bash
